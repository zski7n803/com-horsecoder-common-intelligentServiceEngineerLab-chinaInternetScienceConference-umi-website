...
declare function mode(x: any[]): any;
export { max, mean, min, mode, sum };
export declare const statMap: {
    [key: string]: any;
};
export declare function getColumn(data: IItemData[], columnName: string): any[];
export declare function getSatByColumn(type: string, column: number[]): any;
