...
var _baseMap = _interopRequireDefault(require("../lib/base-map"));
...
class BMapService extends _baseMap.default {
  constructor(...args) {
    super(...args);
    (0, _defineProperty2.default)(this, "viewport", new _webMercatorViewport.default());
    (0, _defineProperty2.default)(this, "version", _types.MapType.GAODE);
  ...
  creatMapContainer(id) {
    ...
    amapdiv.style.cssText += `
       ...
       width: 100%;
     `;
    amapdiv.id = _l7Utils.lodashUtil.uniqueId('l7_amap_div');
  ...
  meterToCoord(center, outer) {
    ...
    // Tip: 三维世界坐标距离
    const [x1, y1] = (0, _l7Utils.amap2Project)(...center);
    const [x2, y2] = (0, _l7Utils.amap2Project)(...outer);
  ...
  lngLatToMercator([lng, lat], altitude) {
    const [x, y] = (0, _l7Utils.amap2Project)(lng, lat);
    return {
      x: x,
      y: y,
      z: altitude
