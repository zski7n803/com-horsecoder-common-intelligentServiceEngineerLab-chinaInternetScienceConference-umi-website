...
const _excluded = ["id", "attributionControl", "style", "rotation", "mapInstance"];
/**
 * MapboxService
 */
...
class Service extends _BaseMapService.default {
  ...
  init() {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      if (mapInstance) {
        ...
        // @ts-ignore
        _this.map = new window.maplibregl.Map((0, _objectSpread2.default)({
  ...
  meterToCoord(center, outer) {
    ...
    const centerLnglat = new _maplibreGl.default.LngLat(center[0], center[1]);
    const outerLnglat = new _maplibreGl.default.LngLat(outer[0], outer[1]);
    const meterDis = centerLnglat.distanceTo(outerLnglat);

    // Tip: 三维世界坐标距离

    const centerMercator = _maplibreGl.default.MercatorCoordinate.fromLngLat({
      lng: center[0],
      lat: center[1]
    });
    const outerMercator = _maplibreGl.default.MercatorCoordinate.fromLngLat({
      lng: outer[0],
      lat: outer[1]
    });
    const {
