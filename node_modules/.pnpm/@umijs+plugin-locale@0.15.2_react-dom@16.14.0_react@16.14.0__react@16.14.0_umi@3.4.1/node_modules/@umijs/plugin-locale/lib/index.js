...
exports.default = exports.packageNormalize = void 0;
...
var _default = api => {
  ...
  api.onGenerateFiles( /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    const NormalizeAntdLocalesName = function NormalizeAntdLocalesName() {
      // @ts-ignore
    ...
    api.writeTmpFile({
      ...
      content: Mustache.render(localeExportsTpl, {
        ...
        LocaleList: localeList.map(locale => _objectSpread(_objectSpread({}, locale), {}, {
