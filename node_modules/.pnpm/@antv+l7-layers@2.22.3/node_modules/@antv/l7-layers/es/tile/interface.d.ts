import type { ILayer, IMapService, IRendererService, ISource, ISubLayerInitOptions } from '@antv/l7-core';
...
export interface ITileFactory {
    loaded: boolean;
    layers: ILayer[];
    createTile(tile: SourceTile, initOptions: ISubLayerInitOptions): {
        layers: ILayer[];
    };
