...
class ShaderUniformPlugin {
  ...
  generateUBO(width, height) {
    ...
    return {
      ...
      uniforms: {
        // 相机参数，包含 VP 矩阵、缩放等级
        [_l7Core.CameraUniform.ProjectionMatrix]: u_ProjectionMatrix,
        [_l7Core.CameraUniform.ViewMatrix]: u_ViewMatrix,
        [_l7Core.CameraUniform.ViewProjectionMatrix]: u_ViewProjectionMatrix,
        [_l7Core.CameraUniform.Zoom]: u_Zoom,
        [_l7Core.CameraUniform.ZoomScale]: u_ZoomScale,
        [_l7Core.CameraUniform.FocalDistance]: u_FocalDistance,
        [_l7Core.CameraUniform.CameraPosition]: u_CameraPosition,
        // 坐标系参数
        [_l7Core.CoordinateUniform.CoordinateSystem]: u_CoordinateSystem,
        [_l7Core.CoordinateUniform.ViewportCenter]: u_ViewportCenter,
        [_l7Core.CoordinateUniform.ViewportCenterProjection]: u_ViewportCenterProjection,
