...
export declare function polygonTriangulationWithCenter(feature: IEncodeFeature): {
    indices: number[];
    vertices: number[];
    size: number;
};
...
export declare function computeVertexNormals(positions: number[], indexArray: number[], dim?: number, needFlat?: boolean): Float32Array;
export declare function checkIsClosed(points: number[][][]): boolean;
/**
 * 构建地球三角网格
 * @returns
 */
