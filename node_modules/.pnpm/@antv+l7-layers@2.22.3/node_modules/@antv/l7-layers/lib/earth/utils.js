...
// 地球网格半径
const EARTH_RADIUS = exports.EARTH_RADIUS = 100;
const EARTH_SEGMENTS = exports.EARTH_SEGMENTS = 36;
const EARTH_RADIUS_OUTER = exports.EARTH_RADIUS_OUTER = 40;
...
function primitiveSphere(radius, opt) {
  const matRotY = _glMatrix.mat4.create();
  const matRotZ = _glMatrix.mat4.create();
  const up = _glMatrix.vec3.fromValues(0, 1, 0);
  const tmpVec3 = _glMatrix.vec3.fromValues(0, 0, 0);
  opt = opt || {};
