...
var _default = (context, opts = {}) => {
  ...
  const preset = {
    ...
    opts.typescript && [require.resolve('@umijs/deps/compiled/babel/babel-plugin-transform-typescript-metadata')], [require('@umijs/deps/compiled/babel/plugin-proposal-decorators').default, {
      ...
      removeImport: true
    }], opts.reactRequire && [require.resolve('@umijs/deps/compiled/babel/babel-plugin-react-require')], opts.dynamicImportNode && [require.resolve('@umijs/deps/compiled/babel/babel-plugin-dynamic-import-node')], opts.autoCSSModules && [require.resolve('@umijs/babel-plugin-auto-css-modules')], opts.svgr && [require.resolve('@umijs/deps/compiled/babel/babel-plugin-named-asset-import'), {
      loaderMap: {
        svg: {
