...
import type { IClusterOptions, IParserCfg, IParserData, ISource, ISourceCFG, ITileParserCFG, ITransform } from '@antv/l7-core';
...
export default class Source extends EventEmitter implements ISource {
    ...
    getTileExtent(e: [number, number, number, number], zoom: number): Array<{
        x: number;
        y: number;
        z: number;
    }> | undefined;
