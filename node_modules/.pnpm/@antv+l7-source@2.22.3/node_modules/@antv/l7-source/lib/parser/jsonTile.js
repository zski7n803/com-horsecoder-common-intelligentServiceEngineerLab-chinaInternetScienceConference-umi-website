...
var jsonTile_exports = {};
__export(jsonTile_exports, {
  default: () => jsonTile
});
module.exports = __toCommonJS(jsonTile_exports);
...
var getVectorTile = (url, tile, requestParameters, getCustomData) => __async(void 0, null, function* () {
  ...
  const tileUrl = (0, import_l7_utils.getURLFromTemplate)(url, params);
