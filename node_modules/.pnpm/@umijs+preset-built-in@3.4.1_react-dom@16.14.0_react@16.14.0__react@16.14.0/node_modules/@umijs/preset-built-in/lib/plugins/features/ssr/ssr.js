...
var _default = api => {
  ...
  api.onGenerateFiles( /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    api.writeTmpFile({
      ...
      content: _utils().Mustache.render(serverContent, {
        ...
        loadingComponent: ((_api$config$dynamicIm = api.config.dynamicImport) === null || _api$config$dynamicIm === void 0 ? void 0 : _api$config$dynamicIm.loading) && (0, _utils().winPath)((_api$config$dynamicIm2 = api.config.dynamicImport) === null || _api$config$dynamicIm2 === void 0 ? void 0 : _api$config$dynamicIm2.loading),
  ...
  api.modifyConfig(config => {
    ...
    config.devServer.writeToDisk = filePath => {
      ...
      const regexp = new RegExp(`(${_constants.OUTPUT_SERVER_FILENAME}|${_constants.OUTPUT_SERVER_TYPE_FILENAME}|${manifestFile})$`);
