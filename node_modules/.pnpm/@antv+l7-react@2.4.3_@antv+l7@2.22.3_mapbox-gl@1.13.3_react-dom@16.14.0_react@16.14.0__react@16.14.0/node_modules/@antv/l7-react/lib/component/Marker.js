...
var MarkerComponet = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(MarkerComponet, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var _this$props2;
      var positionChanged = JSON.stringify(prevProps === null || prevProps === void 0 ? void 0 : prevProps.lnglat) !== JSON.stringify((_this$props2 = this.props) === null || _this$props2 === void 0 ? void 0 : _this$props2.lnglat);
    ...
    value: function render() {
      var _this2 = this;
      return /*#__PURE__*/React.createElement(_SceneContext.SceneContext.Consumer,
      // @ts-ignore
      {}, function (scene) {
        if (scene) {
          _this2.scene = scene;
