...
var CONTROL_TYPE_MAP = {
  exportImage: _l.ExportImage,
  fullscreen: _l.Fullscreen,
  geoLocate: _l.GeoLocate,
  layer: _l.LayerSwitch,
  layerSwitch: _l.LayerSwitch,
  logo: _l.Logo,
  mapTheme: _l.MapTheme,
  mouseLocation: _l.MouseLocation,
  zoom: _l.Zoom,
  scale: _l.Scale
};
var _default = /*#__PURE__*/_react.default.memo(function MapControl(props) {
  ...
  (0, _react.useEffect)(function () {
    var Control = CONTROL_TYPE_MAP[type];
    var ctr = new Control(_objectSpread({
      position: position
    }, rest));
    control.current = ctr;
  ...
  (0, _react.useEffect)(function () {
    if (control.current) {
      // @ts-ignore
      control.current.setPosition(position || 'bottomleft');
    }
  }, [position]);
  return null;
});
