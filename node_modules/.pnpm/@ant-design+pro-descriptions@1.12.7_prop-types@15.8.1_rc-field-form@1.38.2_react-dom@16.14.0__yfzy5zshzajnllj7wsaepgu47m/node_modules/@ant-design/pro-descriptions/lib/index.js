...
var FieldRender = function FieldRender(props) {
  ...
  var fieldConfig = {
    ...
    proFieldProps: {
      render: render ? function () {
        return render === null || render === void 0 ? void 0 : render(text, entity, index, action, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
          type: 'descriptions'
        }));
      } : undefined
    },
  ...
  if (mode === 'read' || !mode || valueType === 'option') {
    ...
    return (0, _jsxRuntime.jsx)(_proForm.ProFormField, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      name: dataIndex
    }, fieldConfig), {}, {
  ...
  var renderDom = function renderDom() {
    ...
    var dom = renderFormItem ? renderFormItem === null || renderFormItem === void 0 ? void 0 : renderFormItem((0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
      type: 'descriptions'
    }), {
      isEditable: true,
      recordKey: dataIndex,
      ...
      defaultRender: function defaultRender() {
        return (0, _jsxRuntime.jsx)(_proForm.ProFormField, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, fieldConfig), {}, {
          fieldProps: fieldProps
        }));
      },
      type: 'descriptions'
    ...
    return (0, _jsxRuntime.jsxs)(_space.default, {
      children: [(0, _jsxRuntime.jsx)(_proUtils.InlineErrorFormItem, (0, _objectSpread2.default)((0, _objectSpread2.default)({
        name: dataIndex
      }, formItemProps), {}, {
        ...
        children: dom || (0, _jsxRuntime.jsx)(_proForm.ProFormField, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, fieldConfig), {}, {
          // @ts-ignore
        ...
        cancelText: (0, _jsxRuntime.jsx)(_icons.CloseOutlined, {}),
        saveText: (0, _jsxRuntime.jsx)(_icons.CheckOutlined, {}),
        deleteText: false
      })]
    });
  };
...
var schemaToDescriptionsItem = function schemaToDescriptionsItem(items, entity, action, editableUtils) {
  ...
  var children = items === null || items === void 0 ? void 0 : (_items$map = items.map) === null || _items$map === void 0 ? void 0 : _items$map.call(items, function (item, index) {
    ...
    var field = /*#__PURE__*/(0, _react.createElement)(_descriptions.default.Item, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, restItem), {}, {
      key: restItem.key || ((_restItem$label = restItem.label) === null || _restItem$label === void 0 ? void 0 : _restItem$label.toString()) || index,
      label: (title || restItem.label || restItem.tooltip || restItem.tip) && (0, _jsxRuntime.jsx)(_proUtils.LabelIconTip, {
        label: title || restItem.label,
        tooltip: restItem.tooltip || restItem.tip,
        ellipsis: item.ellipsis
      })
    }), (0, _jsxRuntime.jsxs)(Component, {
      children: [(0, _jsxRuntime.jsx)(FieldRender, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, item), {}, {
      ...
      })), showEditIcon && valueType !== 'option' && (0, _jsxRuntime.jsx)(_icons.EditOutlined, {
...
var ProDescriptionsItem = function ProDescriptionsItem(props) {
  return (0, _jsxRuntime.jsx)(_descriptions.default.Item, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
...
var ProDescriptions = function ProDescriptions(props) {
  ...
  if (action.loading || action.loading === undefined && request) {
    return (0, _jsxRuntime.jsx)(_proSkeleton.default, {
      type: "descriptions",
      list: false,
      pageHeader: false
    });
  ...
  if (rest.title || rest.tooltip || rest.tip) {
    title = (0, _jsxRuntime.jsx)(_proUtils.LabelIconTip, {
      label: rest.title,
  ...
  return (0, _jsxRuntime.jsx)(_proUtils.ErrorBoundary, {
    children: (0, _jsxRuntime.jsx)(FormComponent, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      form: (_props$editable = props.editable) === null || _props$editable === void 0 ? void 0 : _props$editable.form,
      component: false,
      submitter: false
    }, formProps), {}, {
      onFinish: undefined,
      children: (0, _jsxRuntime.jsx)(_descriptions.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({
        className: className
      }, rest), {}, {
        extra: rest.extra ? (0, _jsxRuntime.jsxs)(_space.default, {
