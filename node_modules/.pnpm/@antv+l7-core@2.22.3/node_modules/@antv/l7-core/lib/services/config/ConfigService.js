...
var _ILayerService = require("../layer/ILayerService");
...
const defaultLayerConfig = {
  ...
  maskLayers: [],
  enableMask: true,
  maskOperation: _ILayerService.MaskOperation.AND,
  pickedFeatureID: -1,
...
class GlobalConfigService {
  constructor() {
     ...
     * 全部场景配置项缓存
     */
    (0, _defineProperty2.default)(this, "sceneConfigCache", {});
    /**
     * 场景配置项校验器
     */
  ...
  setSceneConfig(sceneId, config) {
    this.sceneConfigCache[sceneId] = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, defaultSceneConfig), config);
  }
  ...
  setLayerConfig(sceneId, layerId, config) {
    // @ts-ignore
    this.layerConfigCache[layerId] = (0, _objectSpread2.default)({}, merge({}, this.sceneConfigCache[sceneId], defaultLayerConfig, config));
  }
