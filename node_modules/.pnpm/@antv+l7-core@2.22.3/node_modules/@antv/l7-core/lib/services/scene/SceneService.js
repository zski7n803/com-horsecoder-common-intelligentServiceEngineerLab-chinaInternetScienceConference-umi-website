 ...
 */
class Scene extends _eventemitter.EventEmitter {
  /**
   * 使用各种 Service
   */
  get iconService() {
  ...
  constructor(container) {
    ...
    // TODO: 改成状态机
    (0, _defineProperty2.default)(this, "rendering", false);
    /**
     * canvas 容器
     */
    ...
    (0, _defineProperty2.default)(this, "resizeDetector", void 0);
    (0, _defineProperty2.default)(this, "hooks", void 0);
    (0, _defineProperty2.default)(this, "handleWindowResized", () => {
      this.emit('resize');
      // @ts-check
      if (this.$container) {
        this.initContainer();
    ...
    (0, _defineProperty2.default)(this, "handleMapCameraChanged", viewport => {
  ...
  init(sceneConfig) {
     ...
     * 初始化底图
     */
    this.hooks.init.tapPromise('initMap', /*#__PURE__*/(0, _asyncToGenerator2.default)(function* () {
      ...
      _this.interactionService.on(_IInteractionService.InteractionEvent.Drag, _this.addSceneEvent.bind(_this));
    }));

    /**
     * 初始化渲染引擎
     */
    this.hooks.init.tapPromise('initRenderer', /*#__PURE__*/(0, _asyncToGenerator2.default)(function* () {
      var _this$map;
      ...
      if (renderContainer) {
        ...
        _this.$container = (0, _dom.createRendererContainer)(_this.configService.getSceneConfig(_this.id).id || '');
      }
      ...
      if (_this.$container) {
        ...
        _this.canvas = canvas ? canvas : _l7Utils.DOM.create('canvas', '', _this.$container);
        _this.setCanvas();
        ...
        _this.initContainer();
        _this.resizeDetector = (0, _elementResizeDetector.default)({
  ...
  initContainer() {
    ...
    const pixelRatio = _l7Utils.DOM.DPR;
