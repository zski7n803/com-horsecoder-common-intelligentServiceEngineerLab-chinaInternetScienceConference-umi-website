...
export interface IPostProcessor {
    ...
    add<InitializationOptions>(pass: IPostProcessingPass<InitializationOptions>, layer: ILayer, config?: Partial<InitializationOptions>): void;
...
export interface IMultiPassRenderer {
    ...
    resize(viewportWidth: number, viewportHeight: number): void;
    add<InitializationOptions>(pass: IPass<InitializationOptions>, config?: Partial<InitializationOptions>): void;
    render(): void;
