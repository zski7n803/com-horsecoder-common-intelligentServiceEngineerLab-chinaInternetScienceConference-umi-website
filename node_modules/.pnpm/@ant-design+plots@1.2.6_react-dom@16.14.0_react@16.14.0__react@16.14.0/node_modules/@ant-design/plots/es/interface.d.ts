...
import { Plot, Options, G2, DualAxesOptions, GaugeOptions, BulletOptions, MixOptions, TreemapOptions, TooltipOptions as BaseTooltip, Datum as G2PlotDatum } from '@antv/g2plot';
 ...
 */
export type AllBaseConfig = Options | DualAxesOptions | GaugeOptions | TinyPlotOptions | BulletOptions | MixOptions | TreemapOptions;
/**
 * @title 图表配置
 ...
 */
export type ChartRefConfig = ((chart: Plot<AllBaseConfig>) => void) | React.MutableRefObject<Plot<AllBaseConfig> | undefined>;
/**
 * @title 图表浮窗配置
...
export interface BaseConfig<O extends Omit<AllBaseConfig, 'tooltip'>, P extends Plot<O> = Plot<O>> extends ContainerConfig {
    /**
     * @title 浮窗提示
     * @description 设置浮窗提示
