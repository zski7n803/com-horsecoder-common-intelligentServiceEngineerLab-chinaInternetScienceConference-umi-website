...
import type { ConferenceSubmissionSecondProps } from './types';

/**
 * 组件布局: 会议投稿
 */
const ConferenceSubmissionSecondPage: React.FC<ConferenceSubmissionSecondProps> = () => {
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={styles.divDiv0Div0Div0Div0Div0Div1P10}
                    >
                      6.食宿及交通：请参会人员自行提前预定酒店。组委会推荐武汉光谷潮漫凯瑞国际酒店（罗经理 17671437472）、全季酒店（武汉光谷创业街店）（周经理 18672376616）、武汉丽顿酒店（光谷店）（侯经理18907178850）和锦江都城酒店（武汉华科大光谷创业街店）（皮经理18872340613）4家酒店住宿。<br/>
                    </p>
                    <p
...
export default ConferenceSubmissionSecondPage;
